...
export class Database extends ethereum.SmartContract {
  ...
  getAudit(auditId: BigInt): Database__getAuditResultValue0Struct {
    let result = super.call(
      "getAudit",
      "getAudit(uint256):((uint256,address,uint256,string,string,bool,bool,uint256,uint256,uint256,uint256,bool))",
...
export class ChainLinkAutomationCall extends ethereum.Call {
  get inputs(): ChainLinkAutomationCall__Inputs {
    return new ChainLinkAutomationCall__Inputs(this);
  }

  get outputs(): ChainLinkAutomationCall__Outputs {
    return new ChainLinkAutomationCall__Outputs(this);
  }
}

export class ChainLinkAutomationCall__Inputs {
  _call: ChainLinkAutomationCall;

  constructor(call: ChainLinkAutomationCall) {
    this._call = call;
  }
}

export class ChainLinkAutomationCall__Outputs {
  _call: ChainLinkAutomationCall;
